                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('manufacturers_url',  $editManufacturer->url , array('class'=>'form-control', 'id'=>'manufacturers_url', 'placeholder' => 'your_site_address/shop?category='), value(old('manufacturers_url')))  !!}
