...
<section class="checkout-area">
          ...
          <div class="checkout-module">
            <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
              {{-- @if(session('checkout_type')=='delivery') --}}
                <li class="nav-item" id="pills-shipping-list">
                  <a class="nav-link @if(session('step')==0) active @elseif(session('step')>0)  @endif" @if(session('step')>=0) id="pills-shipping-tab" data-toggle="pill" href="#pills-shipping" role="tab" aria-controls="pills-shipping" aria-selected="false" @endif>
                  <span class="d-flex d-lg-none">1</span>
                  <span class="d-none d-lg-flex">@lang('website.Shipping Address')</span></a>
                </li>
              {{-- @else --}}
                <li style="display:none" class="nav-item" id="pills-pickup-list">
                  <a class="nav-link @if(session('step')==1) active @elseif(session('step')>1) @endif" @if(session('step')>=1) id="pills-pickup-tab" data-toggle="pill" href="#pills-pickup" role="tab" aria-controls="pills-pickup" aria-selected="true" @endif>
                  {{-- <span class="d-flex d-lg-none">2</span> --}}
                  <span class="d-none d-lg-flex">@lang('website.Pickup Address')</a>
                </li>
              {{-- @endif --}}
                <li class="nav-item">
                  <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2) @endif" @if(session('step')>=2) id="pills-billing-tab" data-toggle="pill" href="#pills-billing" role="tab" aria-controls="pills-billing" aria-selected="false"  @endif>
                  {{-- <span class="d-flex d-lg-none">3</span> --}}
                  @lang('website.Billing Address')</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link @if(session('step')==3) active @elseif(session('step')>3) @endif" @if(session('step')>=3) id="pills-method-tab" data-toggle="pill" href="#pills-method" role="tab" aria-controls="pills-method" aria-selected="false" @endif>
                  {{-- <span class="d-flex d-lg-none">4</span> --}}
                  @lang('website.Shipping Methods')</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if(session('step')==4) active @elseif(session('step')>4) @endif"  @if(session('step')>=4) id="pills-order-tab" data-toggle="pill" href="#pills-order" role="tab" aria-controls="pills-order" aria-selected="false" @endif>
                    {{-- <span class="d-flex d-lg-none">5</span> --}}
                    @lang('website.Order Detail')</a>
                </li>
            </ul>
            <ul class="nav nav-pills mb-3 checkoutd-nav d-flex d-lg-none" id="pills-tab" role="tablist">
              {{-- @if(session('checkout_type')=='delivery') --}}
                <li class="nav-item" id="pills-shipping-list2">
                  <a class="nav-link @if(session('step')==0) active @elseif(session('step')>0) active-check @endif" @if(session('step')>=0) id="pills-shipping-tab" data-toggle="pill" href="#pills-shipping" role="tab" aria-controls="pills-shipping" aria-selected="false" @endif>1</a>
                </li>
              {{-- @else --}}
                <li style="display:none" class="nav-item second" id="pills-pickup-list2">
                  <a class="nav-link @if(session('step')==1) active @elseif(session('step')>1) active-check @endif" @if(session('step')>=1) id="pills-pickup-tab" data-toggle="pill" href="#pills-pickup" role="tab" aria-controls="pills-pickup" aria-selected="false" @endif>2</a>
                </li>
              {{-- @endif --}}
                <li class="nav-item third">
                  <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2) active-check @endif" @if(session('step')>=2) id="pills-billing-tab" data-toggle="pill" href="#pills-billing" role="tab" aria-controls="pills-billing" aria-selected="true" @endif >3</a>
                </li>
                <li class="nav-item fourth">
                  <a class="nav-link @if(session('step')==3) active @elseif(session('step')>3) active-check @endif" @if(session('step')>=3) id="pills-method-tab" data-toggle="pill" href="#pills-method" role="tab" aria-controls="pills-method" aria-selected="false" @endif>4</a>
                </li>
                <li class="nav-item fifth">
                  <a class="nav-link @if(session('step')==4) active @elseif(session('step')>4) active-check @endif"  @if(session('step')>=4) id="pills-order-tab" data-toggle="pill" href="#pills-order" role="tab" aria-controls="pills-order" aria-selected="false" @endif>5</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
              {{-- @if(session('checkout_type')=='delivery') --}}
                <div class="tab-pane fade @if(session('step') == 0) show active @endif" id="pills-shipping" role="tabpanel" aria-labelledby="pills-shipping-tab">
                  <form name="signup" enctype="multipart/form-data" class="form-validate"  action="{{ URL::to('/checkout_shipping_address')}}" method="post">
                    <input type="hidden" required name="_token" id="shipping_csrf-token" value="{{ Session::token() }}" />
                    <div class="form-row">
              ...
              {{-- @else --}}
                <div style="display:none" class="tab-pane fade @if(session('step') == 1) show active @endif"  id="pills-pickup" role="tabpanel" aria-labelledby="pills-pickup-tab">
                  <form name="signup" enctype="multipart/form-data" action="{{ URL::to('/checkout_pickup_address')}}" method="post">
                    <input type="hidden" name="_token" id="pickup_csrf-token" value="{{ Session::token() }}" />
                    <div class="form-row">
                      <div class="form-group">
                        <label for=""> @lang('website.First Name')</label>
                        <input type="text"  required class="form-control field-validate" id="pickup_firstname" name="pickup_firstname" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_firstname}}@endif" aria-describedby="NameHelp1" placeholder="Enter Your First Name">{{-- {{session('pickup_address')->firstname}} --}}
                        <span style="color:red;" class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Last Name')</label>
                        <input type="text" required class="form-control field-validate" id="pickup_lastname" name="pickup_lastname" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_lastname}}@endif" aria-describedby="NameHelp1" placeholder="Enter Your Last Name">{{-- {{session('pickup_address')->lastname}} --}}
                        <span style="color:red;" class="help-block error-content" hidden>@lang('website.Please enter your last name')</span>
                      </div>
                      <div class="form-group">
                        <label for="">PickUp @lang('website.Company')</label>
                        <input type="text" class="form-control field-validate" @if(!empty(session('pickup_address'))) @endif  id="pickup_company" name="pickup_company" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_company}}@endif" id="exampleInputCompany2" aria-describedby="companyHelp" placeholder="Enter Your Company Name">
                        <span class="help-block error-content" hidden>@lang('website.Please enter your company name')</span>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Address')</label>
                        <input type="text" class="form-control field-validate" id="exampleInputAddress2" aria-describedby="addressHelp" placeholder="Enter Your Address" @if(!empty(session('22'))>0)  @endif  id="pickup_street" name="pickup_street" value="@if(!empty(session('pickup_address'))>0){{session('pickup_address')->pickup_street}}@endif">
                        <span class="help-block error-content" hidden>@lang('website.Please enter your address')</span>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Country')</label>
                        <div class="input-group select-control">
                            <select required class="form-control field-validate" id="pickup_countries_id" aria-describedby="countryHelp" onChange="getZones();" name="pickup_countries_id">
                              {{-- <option value="" >@lang('website.Select Country')</option> --}}
                              {{-- @if(!empty($result['countries']))
                                @foreach($result['countries'] as $countries)
                                    <option value="{{$countries->countries_id}}" @if(!empty(session('pickup_address'))) @if(session('pickup_address')->pickup_countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>
                                @endforeach
                              @endif --}}
                              <option value="162" @if(!empty(session('pickup_address'))) @endif >{{"Pakistan"}}</option>
                            </select>
                        </div>
                      ...
                      <div class="form-group">
                        <label for=""> @lang('website.State')</label>
                        <div class="input-group select-control">
                            <select required class="form-control select" name="pickup_zone_id" id=pickup_zone_id" aria-describedby="stateHelp">
                              {{-- <option value="" >@lang('website.Select State')</option>
                              @if(!empty($result['zones']))
                                @foreach($result['zones'] as $key=>$zones)
                                    <option value="{{$zones->zone_id}}" @if(!empty(session('pickup_address'))) @endif >{{$zones->zone_name}}</option>
                                @endforeach
                              @endif --}}
                                <option value="-1" @if(!empty(session('pickup_address'))) @endif>@lang('website.Other')</option>
                              </select>
                        </div>
                      ...
                      <div class="form-group">
                        <label for=""> @lang('website.City')</label>
                          <input type="text" class="form-control field-validate" id="pickup_city" name="pickup_city" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_city}}@endif" placeholder="Enter Your City">
                          <span class="help-block error-content" hidden>@lang('website.Please enter your city')</span>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Zip/Postal Code')</label>
                        <input type="text" class="form-control same_address"  id="pickup_zip" name="pickup_zip" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_zip}}@endif" aria-describedby="zpcodeHelp2" placeholder="Enter Your Zip / Postal Code">
                        <small id="zpcodeHelp" class="form-text text-muted"></small>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Phone')</label>
                        <input type="text" class="form-control same_address" id="pickup_phone" name="pickup_phone" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_phone}}@endif" aria-describedby="numberHelp" placeholder="Enter Your Phone Number">
              ...
              {{-- @endif --}}
                <div class="tab-pane fade @if(session('step') == 2) show active @endif"  id="pills-billing" role="tabpanel" aria-labelledby="pills-billing-tab">
                    <form name="signup" enctype="multipart/form-data" action="{{ URL::to('/checkout_billing_address')}}" method="post">
                      <input type="hidden" name="_token" id="billing_csrf-token" value="{{ Session::token() }}" />
                        <div class="form-row">
                          <div class="form-group">
                            <label for=""> @lang('website.First Name')</label>
                            <input type="text" class="form-control same_address" id="exampleInputName1" aria-describedby="NameHelp1" placeholder="Enter Your Name" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_firstname" name="billing_firstname" value="@if(!empty(session('billing_address'))){{ session('billing_address')->billing_firstname }}@endif">{{-- {session('billing_address')->billing_firstname}} --}}
                            <span class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>
                          </div>
                          <div class="form-group">
                            <label for=""> @lang('website.Last Name')</label>
                            <input type="text" class="form-control same_address" id="exampleInputName2" aria-describedby="NameHelp2" placeholder="Enter Your Name" @if(!empty(session('billing_address'))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_lastname" name="billing_lastname" value="@if(!empty(session('billing_address'))>0){{ session('billing_address')->billing_lastname }}@endif">{{-- session('billing_address')->billing_lastname --}}
                          ...
                          <div class="form-group">
                            <label for=""> @lang('website.Country')</label>
                            <div class="input-group select-control">
                                <select required class="form-control same_address_select" id="billing_countries_id" aria-describedby="countryHelp2" onChange="getBillingZones();" name="billing_countries_id" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) disabled @endif @else disabled @endif>
                                  <option value=""  >@lang('website.Select Country')</option>
                                  @if(!empty($result['countries']))
                                    @foreach($result['countries'] as $countries)
                                        <option value="{{$countries->countries_id}}" @if(!empty(session('billing_address'))) @if(session('billing_address')->billing_countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>{{-- @if(session('billing_address')->billing_countries_id == $countries->countries_id) selected @endif --}}
                                    @endforeach
                                  @endif
                                  </select>
                            </div>
                          ...
                          <div class="form-group">
                            <label for=""> @lang('website.State')</label>
                            <div class="input-group select-control">
                                <select required class="form-control same_address_select" name="billing_zone_id" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) disabled @endif @else disabled @endif id="billing_zone_id" aria-describedby="stateHelp2">
                                  {{-- <option value="" >@lang('website.Select State')</option> --}}
                                  {{-- @if(!empty($result['zones']))
                                    @foreach($result['zones'] as $key=>$zones)
                                    ...
                                    @endforeach
                                  @endif --}}
                                    <option value="-1" @if(!empty(session('billing_address')))@if(session('billing_address')->billing_zone_id =='Other') selected @endif @endif>@lang('website.Other')</option>{{-- @if(session('billing_address')->billing_zone_id == 'Other') selected @endif --}}
                                </select>
                            </div>
                            <span class="help-block error-content" hidden>@lang('website.Please select your state')</span>
                          </div>
                          <div class="form-group">
                            <label for=""> @lang('website.City')</label>
                              <input type="text" class="form-control same_address" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_city" name="billing_city" placeholder="Enter Your City" value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_city}}@endif">{{-- value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_city}}@endif" --}}
                              <span class="help-block error-content" hidden>@lang('website.Please enter your city')</span>
                          </div>
                          <div class="form-group">
                            <label for=""> @lang('website.Zip/Postal Code')</label>
                            <input type="text" class="form-control same_address" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_zip" name="billing_zip" aria-describedby="zpcodeHelp2" placeholder="Enter Your Zip / Postal Code" value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_zip}}@endif">{{-- value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_zip}}@endif" --}}
                            <small id="zpcodeHelp" class="form-text text-muted"></small>
                          </div>
                          <div class="form-group">
                            <label for=""> @lang('website.Phone')</label>
                            <input type="text" class="form-control same_address" @if(!empty(session('billing_address'))) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_phone" name="billing_phone" aria-describedby="numberHelp" placeholder="Enter Your Phone Number" value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_phone}}@endif">{{-- value="@if(!empty(session('billing_address'))){{session('billing_address')->billing_phone}}@endif" --}}
                            <span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span>
                          </div>
                        </div>
                        <div class="form-row">
                                          ...
                                          <div class="form-row">
                                              ...
                                              <ul class="list"style="list-style:none; padding: 0px;">
                                                  @foreach($result['shipping_methods'][0]['services'] as $services)
                                                    <li>
                                                      <input checked class="shipping_data" id="Local Pickup" type="checkbox"name="shipping_method" value="{{$services['shipping_method']}}" shipping_price="{{$services['rate']}}"  method_name="Local Pickup" @if(!empty(session('shipping_detail')) and !empty(session('shipping_detail')) > 0)@endif>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <ul class="list"style="list-style:none; padding: 0px;">
                                                    @foreach($result['shipping_methods'][1]['services'] as $services)
                                                      <li>
                                                        <input checked class="shipping_data" id="Shipping Fee" type="checkbox" name="shipping_method" value="{{$services['shipping_method']}}" shipping_price="{{$services['rate']}}"  method_name="Shipping Fee" @if(!empty(session('shipping_detail')) and !empty(session('shipping_detail')) > 0)@endif>
                                                          {{-- @if(session('shipping_detail')->mehtod_name == "Shipping Fee") checked  @endif> --}}
                                                        
                                                        <label for="Shipping Fee">{{$services['name']}} ---                                                          
                                                          @if($result['commonContent']['setting'][82]->value<=session('total_price')){{Session::get('symbol_left')}}0
                                                          @else{{Session::get('symbol_left')}}{{$services['rate']*session('currency_value')}}{{Session::get('symbol_right')}}@endif
                                                        </label>
                                                      </li>
                                                    @endforeach
                                                </ul>
                ...
                <div class="tab-pane fade @if(session('step') == 4) show active @endif" id="pills-order" role="tabpanel" aria-labelledby="pills-method-order">
                              <?php
                                  $price = 0;
                              ?>
                                                ...
                                                @if($payment_methods['active']==1)
                                                    <input id="payment_currency" type="hidden" onClick="paymentMethods();" name="payment_currency" value="{{$payment_methods['payment_currency']}}">
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <input checked onClick="paymentMethods();" id="{{$payment_methods['payment_method']}}_label" type="checkbox" name="payment_method" class="form-check-input payment_method" value="{{$payment_methods['payment_method']}}" @if(!empty(session('payment_method'))) @if(session('payment_method')==$payment_methods['payment_method']) checked @endif @endif>
  ...
  if(!empty($result['commonContent']['setting'][72]->value)){
    $name = $result['commonContent']['setting'][72]->value;
  }else{
