          ...
          <div class="checkout-module">
            <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
              {{-- @if(session('checkout_type')=='delivery') --}}
                <li class="nav-item" id="pills-shipping-list">
                  <a class="nav-link @if(session('step')==0) active @elseif(session('step')>0)  @endif" @if(session('step')>=0) id="pills-shipping-tab" data-toggle="pill" href="#pills-shipping" role="tab" aria-controls="pills-shipping" aria-selected="true" @endif>
              ...
              {{-- @else --}}
                <li style="display:none" class="nav-item" id="pills-pickup-list">
                  <a class="nav-link @if(session('step')==1) active @elseif(session('step')>1) @endif" @if(session('step')>=1) id="pills-pickup-tab" data-toggle="pill" href="#pills-pickup" role="tab" aria-controls="pills-pickup" aria-selected="false" @endif>
            ...
            <ul class="nav nav-pills mb-3 checkoutd-nav d-flex d-lg-none" id="pills-tab" role="tablist">
                <li class="nav-item" id="pills-shipping-list2">
                  <a class="nav-link @if(session('step')==0) active @elseif(session('step')>0) active-check @endif" @if(session('step')>=0) id="pills-shipping-tab" data-toggle="pill" href="#pills-shipping" role="tab" aria-controls="pills-shipping" aria-selected="true" @endif>1</a>
                </li>
                ...
                <li class="nav-item third">
                  <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2) active-check @endif" @if(session('step')>=2) id="pills-billing-tab" data-toggle="pill" href="#pills-billing" role="tab" aria-controls="pills-billing" aria-selected="false" @endif >3</a>
                </li>
                ...
                <div style="display:none" class="tab-pane fade @if(session('step') == 1) show active @endif"  id="pills-pickup" role="tabpanel" aria-labelledby="pills-pickup-tab">
                  <form name="signup" enctype="multipart/form-data" action="{{ URL::to('/checkout_pickup_address')}}" method="post">
                    ...
                    <div class="form-row">
                      <div class="form-group">
                        <label for=""> @lang('website.First Name')</label>
                        <input type="text"  required class="form-control field-validate" id="pickup_firstname" name="pickup_firstname" value="@if(!empty(session('pickup_address'))){{session('pickup_address')->pickup_firstname}}@endif" aria-describedby="NameHelp1" placeholder="Enter Your Name">{{-- {{session('pickup_address')->firstname}} --}}
                        <span style="color:red;" class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>
                      </div>
                      <div class="form-group">
                        <label for=""> @lang('website.Last Name')</label>
