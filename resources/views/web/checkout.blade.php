           ...
           <div class="checkout-module">
               <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
                 <li class="nav-item">
                    ...
                    <span class="d-none d-lg-flex"><div id="label_SA">@lang('website.Shipping Address')</div></span></a>
                 </li>
                 <li class="nav-item">
                          ...
                          <div class="input-group select-control">
                              <select required class="form-control field-validate" id="entry_country_id" onChange="getZones();" name="countries_id" aria-describedby="countryHelp">
                                ...
                                {{-- @if(!empty($result['countries']))
                                  ...
                                  @endforeach
                                @endif --}}
                                  <option value="162" @if(!empty(session('shipping_address'))) @if(session('shipping_address')->countries_id == '162') selected @endif @endif>{{-- @lang('website.Pakistan') --}}Pakistan</option>
                                </select>
                          </div>
...
<script>
  jQuery(document).ready(function($result){
    ...
    jQuery('#delivery').click(function(e){
        e.preventDefault();
        // var myText = document.getElementById("delivery").text;
        // document.getElementById('label_SA').innerHTML = "Shipping Address";
    ...
    jQuery(document).ready(function($result){
      jQuery('#pickup').click(function(e, $result){
          e.preventDefault();
            ...
            var postValue = "75100";
            var city = "Karachi";
            // $result['settingsContent']['setting']['app_name'];
            // {{-- var cValue = "{{ $appname }}" --}}
            // var cValue = JSON.stringify($appname);
