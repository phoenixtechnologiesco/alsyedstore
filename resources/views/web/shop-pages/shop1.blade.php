             ...
             <form enctype="multipart/form-data" name="filters" id="test" method="get">
              ...
              @endif               
                  ...
                  <div class="col-12 col-lg-9">
                      {{-- @if($result['products']['success']==1 and $result['child_present']==0) --}}
                        <div class="products-area">
                          ...
                          <section id="swap" class="shop-content" >
                                <div class="products-area">
                                    <div class="row">  
                                      ...
                                      @if(!empty($result['child_categories']) and count($result['child_categories'])>0)
                                        @foreach($result['child_categories'] as $key=>$categories)   
                                          <div class="col-12 col-lg-4 col-sm-6 griding">
                                            @include('web.common.subCategory')
                                          </div>
                                        @endforeach
                                      @else
                          ...
                          <div class="pagination justify-content-between ">
                              @if($result['child_count']==0 and $result['products']['success']==1)
                              ...
                              @elseif($result['child_count']>0)
                                <input id="record_limit" type="hidden" value="{{$result['child_count']}}">
                                <input id="total_record" type="hidden" value="{{$result['child_count']}}">
                                <label for="staticEmail" class="col-form-label"> @lang('website.Showing')&nbsp;<span class="showing_record">{{$result['child_count']}}</span>&nbsp;@lang('website.of')&nbsp;<span class="showing_total_record">{{$result['child_count']}}</span> &nbsp;@lang('website.results')</label>
                              @else
