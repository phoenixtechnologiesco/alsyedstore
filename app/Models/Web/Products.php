...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function getMainCategories($category_id)
    {
        ...
        // ->where('categories.categories_status', 1)
        ->where('categories.categories_id', $category_id)->where('language_id', Session::get('language_id'))->get();
        return $main_category;
    }

    public function getChildCategories($parent_id)
    {
        $child_category = DB::table('categories')
        ->leftJoin('categories_description', 'categories_description.categories_id', '=', 'categories.categories_id')
        ->leftJoin('image_categories', 'categories.categories_icon', '=', 'image_categories.image_id')
        ->select('categories.categories_id', 'image_categories.path as image_path', 'categories.categories_slug as slug', 'categories_description.categories_name', 'categories.parent_id')
        // ->where('categories.categories_status', 1)
        ->where('categories.parent_id', $parent_id)->where('language_id', Session::get('language_id'))
