            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group <?php echo e($errors->has('purchase_code') ? ' has-error ' : ''); ?>">
                    <label for="purchase_code">
                      Purchase Code (<a target="_blank" href="http://tiny.cc/ra1xiz">About</a>)
                    </label>
                    <input type="text" required name="purchase_code" id="purchase_code" value="<?php echo e(old('purchase_code')); ?>" placeholder="Random value!" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\uzair.siddiq\Downloads\Laravel Ecommerce v1.0.19\SourceCode\adminpanel\resources\views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>